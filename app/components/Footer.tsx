        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              />
              <span className="text-xl font-bold">TGAF</span>
            </div>
            ...
            <div className="flex space-x-6">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.618 5.367 11.986 11.988 11.986 6.618 0 11.986-5.368 11.986-11.986C24.003 5.367 18.635.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.553 3.5 13.117 3.5 11.493s.698-3.06 1.626-4.198c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.928 1.138 1.626 2.575 1.626 4.198s-.698 3.06-1.626 4.198c-.875.807-2.026 1.297-3.323 1.297zm7.138 0c-1.297 0-2.448-.49-3.323-1.297-.928-1.138-1.626-2.575-1.626-4.198s.698-3.06 1.626-4.198c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.928 1.138 1.626 2.575 1.626 4.198s-.698 3.06-1.626 4.198c-.875.807-2.026 1.297-3.323 1.297z" />
                </svg>
              </a>
            </div>
          </div>
