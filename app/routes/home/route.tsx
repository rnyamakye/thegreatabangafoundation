      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            ...
            and cared for. We provide scholarships, tuition assistance, and
            educational support to help deserving students achieve their dreams
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-20">
          <div className="text-center p-6 bg-transparent rounded-lg">
          ...
          <div className="text-center p-6 bg-transparent rounded-lg">
            <div className="text-4xl font-bold tgaf-orange mb-2">8</div>
            <div className="text-black font-medium">Universities Partnered</div>
          </div>
          <div className="text-center p-6 bg-transparent rounded-lg">
        ...
        <div className="bg-transparent rounded-2xl p-12 mb-20">
