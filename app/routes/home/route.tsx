      ...
      <main className="min-h-screen transition-colors duration-200 bg-gradient-to-br from-gray-100 via-gray-200 to-gray-100">
        <div className="max-w-6xl px-6 py-20 mx-auto">
          ...
          <div className="mb-20 text-center reveal-fade-in" ref={addToRefs}>
            ...
            <h1
              className="mb-6 text-5xl font-bold text-gray-900 md:text-5xl reveal-slide-up"
              ref={addToRefs}
            >
            ...
            <p
              className="mb-6 text-2xl font-semibold md:text-3xl tgaf-orange reveal-slide-up"
              ref={addToRefs}
            >
            ...
            <p
              className="max-w-4xl mx-auto mb-6 text-xl leading-relaxed text-gray-700 reveal-slide-up"
              ref={addToRefs}
            >
          ...
          >
            ...
            >
              ...
              <div className="font-medium text-black">Community Investment</div>
            </div>
            <div
              className="p-6 text-center bg-transparent rounded-lg reveal-slide-up"
              ref={addToRefs}
            >
              ...
              <div className="font-medium text-black">University Partnered</div>
            </div>
            <div
              className="p-6 text-center bg-transparent rounded-lg reveal-slide-up"
              ref={addToRefs}
