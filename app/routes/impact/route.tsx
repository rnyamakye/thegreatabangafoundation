      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            ...
            education and creating lasting change in communities across Africa.
          </p>
        </div>

        {/* Impact Stats Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center p-8 bg-transparent rounded-xl">
          ...
          <div className="text-center p-8 bg-transparent rounded-xl">
            <div className="text-5xl font-bold text-orange-600 mb-2">₵45K+</div>
            <div className="text-xl font-semibold text-gray-900 mb-2">
              Total Investment
            </div>
            <div className="text-gray-600">
        ...
        <div className="mb-16">
          ...
          <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  ...
                  scholarship support covering her tuition and living expenses,
                  she graduated summa cum laude with a degree in Biology and is
                  now pursuing her medical degree.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  "TGAF didn't just give me financial support; they gave me hope
                  and showed me that someone believed in my dreams. Today, I'm
                  one step closer to serving my community as a doctor."
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
                  Emmanuel's Tech Innovation
                </h3>
                <p className="text-gray-600 leading-relaxed mb-4">
                  Emmanuel came from a family where technology seemed out of
                  reach. Through TGAF's support, he pursued Computer Science and
                  developed a mobile app that helps farmers connect with buyers
                  directly, increasing their income by 40%.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  "The foundation taught me that with education and
                  determination, I could not only change my life but also impact
                  my entire community. My app now serves over 500 farmers."
                </p>
                <div className="mt-4 text-orange-600 font-semibold">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  ...
                  constraints made it seem impossible. With TGAF's scholarship,
                  she completed her Education degree and now leads a rural
                  school, inspiring the next generation of students.
                </p>
                <p className="text-gray-600 leading-relaxed">
