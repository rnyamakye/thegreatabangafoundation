  ...
  const processPayment = (amount: number) => {
    ...
    const handler = window.PaystackPop.setup({
      ...
      callback: function(response: any) {
        setIsLoading(false);
        toast.success(`Thank you ${donorInfo.name}! Your donation of ₵${amount} was successful. Reference: ${response.reference}`);
      ...
      onClose: function() {
        setIsLoading(false);
        toast.error("Payment was cancelled. Please try again if you wish to donate.");
      }
    });
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="space-y-6">
              ...
              <p className="text-lg text-[#3E2723]/80 leading-relaxed">
                Your generous donation empowers us to continue our vital work in
                education, healthcare, and community development. Together, we
                can create lasting change and build a brighter future.
              </p>
            ...
            <div className="">
              ...
              <div className="p-8 bg-white shadow-xl rounded-2xl">
                ...
                <div className="mb-6 space-y-4">
                  <h4 className="text-lg font-semibold text-[#3E2723]">Your Information</h4>
                  
                  <div>
                    <label htmlFor="donor-name" className="block text-sm font-medium text-[#3E2723] mb-1">
                      Full Name *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="donor-email" className="block text-sm font-medium text-[#3E2723] mb-1">
                      Email Address *
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label htmlFor="donor-phone" className="block text-sm font-medium text-[#3E2723] mb-1">
